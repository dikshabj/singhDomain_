...
import { verifyOtp, getSavedEmail, isLoggedIn, resendOtp } from '@/lib/auth'
            ...
            <div className="glass-card p-8 md:p-10 border-yellow-500/20 hover:border-yellow-500/30 shadow-2xl">
              ...
              <div className="mt-6 text-center">
                <button
                  ...
                  className="text-sm font-semibold text-yellow-600 dark:text-yellow-400 hover:underline disabled:opacity-50 disabled:no-underline"
                >
