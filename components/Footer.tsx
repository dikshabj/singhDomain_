    ...
    <>
      ...
      <section className="py-20 px-6 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto text-center">
          <h2 className="text-3xl font-bold text-white mb-10">Join the Community</h2>
      ...
      {/* Footer */}
      <footer className="border-t px-6 py-16 relative" style={{borderColor:'rgba(255,255,255,0.05)', background:'#050508'}}>
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 items-start">
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-white text-2xl font-bold" style={{fontFamily:'Bebas Neue', letterSpacing:'0.15em'}}>
                SINGH
              </span>
            </div>
          ...
          {/* Company links */}
          <div>
            <h4 className="text-white font-semibold mb-5 uppercase tracking-widest text-sm">Company</h4>
            <ul className="space-y-3">
              {['About', 'App', 'Premium DNS', 'Become a partner'].map(link => (
                <li key={link}>
                  <Link href="#" className="text-gray-400 hover:text-yellow-400 transition-colors text-sm flex items-center gap-2">
          ...
          {/* App downloads */}
          <div>
            <h4 className="text-white font-semibold mb-5 uppercase tracking-widest text-sm">Download Singh Social Media app:</h4>
